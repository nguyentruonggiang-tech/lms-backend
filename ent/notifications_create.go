...
func (_c *NotificationsCreate) SetUsersID(id int) *NotificationsCreate {
	_c.mutation.SetUsersID(id)
	return _c
}

// SetUsers sets the "Users" edge to the Users entity.
func (_c *NotificationsCreate) SetUsers(v *Users) *NotificationsCreate {
...
func (_c *NotificationsCreate) check() error {
	...
	if len(_c.mutation.UsersIDs()) == 0 {
		return &ValidationError{Name: "Users", err: errors.New(`ent: missing required edge "Notifications.Users"`)}
	}
	return nil
}
