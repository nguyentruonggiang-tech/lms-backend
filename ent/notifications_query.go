...
func (_q *NotificationsQuery) QueryUsers() *UsersQuery {
...
func (_q *NotificationsQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *NotificationsQuery) FirstIDX(ctx context.Context) int {
...
func (_q *NotificationsQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *NotificationsQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *NotificationsQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *NotificationsQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *NotificationsQuery) WithUsers(opts ...func(*UsersQuery)) *NotificationsQuery {
	query := (&UsersClient{config: _q.config}).Query()
...
func (_q *NotificationsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Notifications, error) {
	...
	if query := _q.withUsers; query != nil {
		if err := _q.loadUsers(ctx, query, nodes, nil,
			func(n *Notifications, e *Users) { n.Edges.Users = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *NotificationsQuery) loadUsers(ctx context.Context, query *UsersQuery, nodes []*Notifications, init func(*Notifications), assign func(*Notifications, *Users)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Notifications)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *NotificationsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(notifications.Table, notifications.Columns, sqlgraph.NewFieldSpec(notifications.FieldID, field.TypeInt))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUsers != nil {
			_spec.Node.AddColumnOnce(notifications.FieldUserID)
		}
	}
