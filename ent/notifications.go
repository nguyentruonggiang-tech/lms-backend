...
func (e NotificationsEdges) UsersOrErr() (*Users, error) {
	if e.Users != nil {
		return e.Users, nil
...
// QueryUsers queries the "Users" edge of the Notifications entity.
func (_m *Notifications) QueryUsers() *UsersQuery {
	return NewNotificationsClient(_m.config).QueryUsers(_m)
}
