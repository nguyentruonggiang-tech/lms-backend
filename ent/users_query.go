...
type UsersQuery struct {
	...
	withNotifications    *NotificationsQuery
...
func (_q *UsersQuery) QueryEnrollments() *EnrollmentsQuery {
...
func (_q *UsersQuery) QueryLessonProgresses() *LessonProgressesQuery {
...
func (_q *UsersQuery) QueryQuizAttempts() *QuizAttemptsQuery {
...
func (_q *UsersQuery) QueryCertificates() *CertificatesQuery {
...
func (_q *UsersQuery) QueryNotifications() *NotificationsQuery {
...
func (_q *UsersQuery) WithEnrollments(opts ...func(*EnrollmentsQuery)) *UsersQuery {
	query := (&EnrollmentsClient{config: _q.config}).Query()
...
func (_q *UsersQuery) WithLessonProgresses(opts ...func(*LessonProgressesQuery)) *UsersQuery {
	query := (&LessonProgressesClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UsersQuery) WithQuizAttempts(opts ...func(*QuizAttemptsQuery)) *UsersQuery {
	query := (&QuizAttemptsClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UsersQuery) WithCertificates(opts ...func(*CertificatesQuery)) *UsersQuery {
	query := (&CertificatesClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UsersQuery) WithNotifications(opts ...func(*NotificationsQuery)) *UsersQuery {
	query := (&NotificationsClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UsersQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Users, error) {
	...
	if query := _q.withEnrollments; query != nil {
		if err := _q.loadEnrollments(ctx, query, nodes,
			func(n *Users) { n.Edges.Enrollments = []*Enrollments{} },
			func(n *Users, e *Enrollments) { n.Edges.Enrollments = append(n.Edges.Enrollments, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLessonProgresses; query != nil {
		if err := _q.loadLessonProgresses(ctx, query, nodes,
			func(n *Users) { n.Edges.LessonProgresses = []*LessonProgresses{} },
			func(n *Users, e *LessonProgresses) { n.Edges.LessonProgresses = append(n.Edges.LessonProgresses, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withQuizAttempts; query != nil {
		if err := _q.loadQuizAttempts(ctx, query, nodes,
			func(n *Users) { n.Edges.QuizAttempts = []*QuizAttempts{} },
			func(n *Users, e *QuizAttempts) { n.Edges.QuizAttempts = append(n.Edges.QuizAttempts, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCertificates; query != nil {
		if err := _q.loadCertificates(ctx, query, nodes,
			func(n *Users) { n.Edges.Certificates = []*Certificates{} },
			func(n *Users, e *Certificates) { n.Edges.Certificates = append(n.Edges.Certificates, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withNotifications; query != nil {
		if err := _q.loadNotifications(ctx, query, nodes,
			func(n *Users) { n.Edges.Notifications = []*Notifications{} },
			func(n *Users, e *Notifications) { n.Edges.Notifications = append(n.Edges.Notifications, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UsersQuery) loadEnrollments(ctx context.Context, query *EnrollmentsQuery, nodes []*Users, init func(*Users), assign func(*Users, *Enrollments)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(enrollments.FieldUserID)
	}
	query.Where(predicate.Enrollments(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(users.EnrollmentsColumn), fks...))
	}))
...
func (_q *UsersQuery) loadLessonProgresses(ctx context.Context, query *LessonProgressesQuery, nodes []*Users, init func(*Users), assign func(*Users, *LessonProgresses)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Users)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(lessonprogresses.FieldUserID)
	}
	query.Where(predicate.LessonProgresses(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(users.LessonProgressesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UsersQuery) loadQuizAttempts(ctx context.Context, query *QuizAttemptsQuery, nodes []*Users, init func(*Users), assign func(*Users, *QuizAttempts)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Users)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(quizattempts.FieldUserID)
	}
	query.Where(predicate.QuizAttempts(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(users.QuizAttemptsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UsersQuery) loadCertificates(ctx context.Context, query *CertificatesQuery, nodes []*Users, init func(*Users), assign func(*Users, *Certificates)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Users)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(certificates.FieldUserID)
	}
	query.Where(predicate.Certificates(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(users.CertificatesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UsersQuery) loadNotifications(ctx context.Context, query *NotificationsQuery, nodes []*Users, init func(*Users), assign func(*Users, *Notifications)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Users)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(notifications.FieldUserID)
	}
