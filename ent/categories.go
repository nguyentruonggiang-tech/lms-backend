...
func (e CategoriesEdges) CoursesOrErr() ([]*Courses, error) {
	if e.loadedTypes[0] {
...
func (*Categories) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case categories.FieldName, categories.FieldSlug, categories.FieldDescription:
			values[i] = new(sql.NullString)
		case categories.FieldDeletedAt, categories.FieldCreatedAt, categories.FieldUpdatedAt:
...
// QueryCourses queries the "Courses" edge of the Categories entity.
func (_m *Categories) QueryCourses() *CoursesQuery {
	return NewCategoriesClient(_m.config).QueryCourses(_m)
}
