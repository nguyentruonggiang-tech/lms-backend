...
func (_c *UsersCreate) SetStatus(v users.Status) *UsersCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *UsersCreate) SetNillableStatus(v *users.Status) *UsersCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *UsersCreate) AddEnrollments(v ...*Enrollments) *UsersCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UsersCreate) AddLessonProgressIDs(ids ...int) *UsersCreate {
	_c.mutation.AddLessonProgressIDs(ids...)
	return _c
}

// AddLessonProgresses adds the "LessonProgresses" edges to the LessonProgresses entity.
func (_c *UsersCreate) AddLessonProgresses(v ...*LessonProgresses) *UsersCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UsersCreate) AddQuizAttemptIDs(ids ...int) *UsersCreate {
	_c.mutation.AddQuizAttemptIDs(ids...)
	return _c
}

// AddQuizAttempts adds the "QuizAttempts" edges to the QuizAttempts entity.
func (_c *UsersCreate) AddQuizAttempts(v ...*QuizAttempts) *UsersCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UsersCreate) AddCertificateIDs(ids ...int) *UsersCreate {
	_c.mutation.AddCertificateIDs(ids...)
	return _c
}

// AddCertificates adds the "Certificates" edges to the Certificates entity.
func (_c *UsersCreate) AddCertificates(v ...*Certificates) *UsersCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UsersCreate) AddNotificationIDs(ids ...int) *UsersCreate {
	_c.mutation.AddNotificationIDs(ids...)
	return _c
}

// AddNotifications adds the "Notifications" edges to the Notifications entity.
func (_c *UsersCreate) AddNotifications(v ...*Notifications) *UsersCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
